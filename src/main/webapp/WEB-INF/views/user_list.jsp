      						...
      						<c:forEach items="${users}" var="user">
  								<div class="list-group-item list-group-item-action flex-column align-items-start">
    								...
    								<div class="form-group d-flex flex-md-row flex-column justify-content-around">
    									...
    									<button type="button" class="btn btn-danger btn-sm btnStyle col-12 col-md-4 m-md-auto" data-toggle="modal" data-target="#deleteModal${user.id}">Supprimer mon compte</button>
    									<div class="modal fade" id="deleteModal${user.id}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  											<div class="modal-dialog" role="document">
    											<div class="modal-content">
      												<div class="modal-header">
        												<h5 class="modal-title" id="deleteModalLabel">Confirmer la suppression du compte de <c:out value="${user.nickName}" /></h5>
      												...
      												<div class="modal-footer d-flex flex-md-row flex-column justify-content-around">
      													<a class="btn btn-primary btn-sm col-12 col-md-4 m-auto" href="<c:url value="/compte/${user.id}/deleteuser"/>" role="button">Oui</a>
