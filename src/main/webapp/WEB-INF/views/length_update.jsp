...
<html>
	<head>
		<meta charset="UTF-8">
		<title>MAJ de la longueur <c:out value="${ updateLength.lengthName }" /></title>
			...
			<div class="col-md-8 mx-auto">
   				<div class="card border-secondary">
   					<div class="card-header">
     					<h1 class="text-center">Mise à jour de la longueur</h1>
    				</div>
    				<div class="card-body">
     					<form:form action="updatelength" class="form" method="post" modelAttribute="updateLength">
							<form:hidden path="id" />
      						...
      						<div class="form-group">
       							<label class="col-md-6 control-label" for="lengthHeight">Hauteur de la longueur : <span class="requis">*</span></label>
       							<div class="col-md-10">
										<form:input path="lengthHeight" class="form-control" type="number" placeholder="${updateLength.updateLengthHeight}" />
										<form:errors path="lengthHeight" cssClass="error" />
								</div>
       						</div>
       						
      						<div class="form-group">
       							<label class="col-md-6 control-label" for="lengthRelay">Nombre de relais (si il y en a) : </label>
       							<div class="col-md-10">
										<form:input path="lengthRelay" class="form-control" type="number" placeholder="${updateLength.updateLengthRelay}" />
										<form:errors path="lengthRelay" cssClass="error" />
								</div>
       						</div>
