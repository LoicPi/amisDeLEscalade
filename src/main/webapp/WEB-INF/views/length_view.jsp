...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Longueur n°<c:out value="${ length.lengthId }" /></title>
      		...
      		<div class="col-md-8 mx-auto">
   				<div class="card border-secondary">
   					<div class="card-header text-center">
						<h1>Vue de la longeur n°<c:out value="${ length.lengthId }" /></h1>
					...
					<div class="card-body">
						...
						<div class="form-group row justify-content-center">
								...
								<label class="col-md-6 col-10 col-form-label form-control-label border"><c:out value="${ length.level.levelName }" /></label>
						</div>
						<c:if test="${ length.lengthSpit }">
							<div class="form-group">
								<label class="control-label">
									<a class="col-md-4">La voie est dite "équipées".</em></a>
								</label>
							</div>
						</c:if>
					</div>
